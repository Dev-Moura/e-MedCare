...
"[project]/src/app/pacient/create/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Home() {
    ...
    const addPacient = async (e)=>{
        e.preventDefault();
        setError(null);
        if (name != "" && login != "" && password != "" && email != "" && phone != "" && birthDate != "") {
            const formData = {
                name: name,
                login: login,
                password: password,
...
_s(Home, "LT7VnAWbb7mPr7yc+vbPcJavzek=", false, function() {
    return [
