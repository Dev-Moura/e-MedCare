...
<<<<<<< HEAD
    ...
    <div>
        ...
        <p className="mt-4 text-gray-600">Atendimento médico multiprofissional com foco em prevenção e bem-estar. Agende sua consulta online ou venha nos visitar.</p>

        <div className="mt-6 flex gap-4">
        <a href="#contact" className="px-6 py-3 bg-blue-600 text-white rounded-md shadow">Agendar Consulta</a>
        <a href="#services" className="px-6 py-3 border border-gray-200 rounded-md text-gray-700">Conhecer Serviços</a>
        </div>

        <ul className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
        <li className="flex items-start gap-3">
            <span className="inline-block w-10 h-10 bg-white rounded-md shadow flex items-center justify-center">🏥</span>
            <div>
            <div className="text-sm font-semibold">Estrutura Completa</div>
            <div className="text-xs text-gray-500">Consultórios e salas equipadas</div>
            </div>
        </li>
        <li className="flex items-start gap-3">
            <span className="inline-block w-10 h-10 bg-white rounded-md shadow flex items-center justify-center">🩺</span>
            ...
            <div className="text-xs text-gray-500">Diversas áreas da medicina</div>
            </div>
        </li>
        <li className="flex items-start gap-3">
            <span className="inline-block w-10 h-10 bg-white rounded-md shadow flex items-center justify-center">⏱️</span>
            <div>
            <div className="text-sm font-semibold">Atendimento Rápido</div>
            <div className="text-xs text-gray-500">Agendamento online e plantões</div>
=======
